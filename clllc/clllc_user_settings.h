...
//
// Wireless primary resonant-current magnitude, sampled at the ISR2 rate.
//
#define CLLLC_IPRIM_TANK_MOD_ADC_MODULE         ADCA_BASE
#define CLLLC_IPRIM_TANK_MOD_ADC_PIN            ADC_CH_ADCIN5
#define CLLLC_IPRIM_TANK_MOD_ADC_ACQPS_SYS_CLKS CLLLC_ADC_ACQPS_SYS_CLKS
#define CLLLC_IPRIM_TANK_MOD_ADCRESULTREGBASE   ADCARESULT_BASE
#define CLLLC_IPRIM_TANK_MOD_ADC_TRIG_SOURCE    CLLLC_ADC_SOC_TRIG_ISR2
#define CLLLC_IPRIM_TANK_MOD_ADC_SOC_NO         ADC_SOC_NUMBER2
#define CLLLC_IPRIM_TANK_MOD_ADCREAD ADC_readResult(                 \
        CLLLC_IPRIM_TANK_MOD_ADCRESULTREGBASE,                       \
...
//
// Wireless primary resonant-current phase, sampled at the ISR2 rate.
//
#define CLLLC_IPRIM_TANK_PHS_ADC_MODULE         ADCC_BASE
#define CLLLC_IPRIM_TANK_PHS_ADC_PIN            ADC_CH_ADCIN11
#define CLLLC_IPRIM_TANK_PHS_ADC_ACQPS_SYS_CLKS CLLLC_ADC_ACQPS_SYS_CLKS
#define CLLLC_IPRIM_TANK_PHS_ADCRESULTREGBASE   ADCCRESULT_BASE
#define CLLLC_IPRIM_TANK_PHS_ADC_TRIG_SOURCE    CLLLC_ADC_SOC_TRIG_ISR2
#define CLLLC_IPRIM_TANK_PHS_ADC_SOC_NO         ADC_SOC_NUMBER2
#define CLLLC_IPRIM_TANK_PHS_ADCREAD ADC_readResult(                 \
        CLLLC_IPRIM_TANK_PHS_ADCRESULTREGBASE,                       \
