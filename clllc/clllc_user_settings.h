...
#define CLLLC_ADC_SOC_TRIG_ISR2             ADC_TRIGGER_EPWM5_SOCA
...
//
// Unused ADCA5 diagnostic channel, sampled at the ISR2 rate.
// WLESS note: J26.28 / ADCA5 is not currently driven by a valid ITANK_PHS
// conditioning circuit on the modified boards, so it must not be used for
// rectifier control.
//
#define CLLLC_UNUSED_ADCA5_ADC_MODULE           ADCA_BASE
#define CLLLC_UNUSED_ADCA5_ADC_PIN              ADC_CH_ADCIN5
#define CLLLC_UNUSED_ADCA5_ADC_ACQPS_SYS_CLKS   CLLLC_ADC_ACQPS_SYS_CLKS
#define CLLLC_UNUSED_ADCA5_ADCRESULTREGBASE     ADCARESULT_BASE
#define CLLLC_UNUSED_ADCA5_ADC_TRIG_SOURCE      CLLLC_ADC_SOC_TRIG_ISR2
#define CLLLC_UNUSED_ADCA5_ADC_SOC_NO           ADC_SOC_NUMBER2
#define CLLLC_UNUSED_ADCA5_ADCREAD ADC_readResult(                  \
        CLLLC_UNUSED_ADCA5_ADCRESULTREGBASE,                        \
        CLLLC_UNUSED_ADCA5_ADC_SOC_NO)

//
// WLESS ITANK debug channel, sampled at the ISR2 rate.
// Modified-board mapping under test: ITANK -> J26.37 -> ADCA12.
//
#define CLLLC_ITANK_ADC_MODULE                  ADCA_BASE
#define CLLLC_ITANK_ADC_PIN                     ADC_CH_ADCIN12
#define CLLLC_ITANK_ADC_ACQPS_SYS_CLKS          CLLLC_ADC_ACQPS_SYS_CLKS
#define CLLLC_ITANK_ADCRESULTREGBASE            ADCARESULT_BASE
#define CLLLC_ITANK_ADC_TRIG_SOURCE             CLLLC_ADC_SOC_TRIG_ISR2
#define CLLLC_ITANK_ADC_SOC_NO                  ADC_SOC_NUMBER14
#define CLLLC_ITANK_ADCREAD ADC_readResult(                         \
        CLLLC_ITANK_ADCRESULTREGBASE,                               \
...
//
// WLESS ITANK_MOD, sampled at the ISR2 rate.
// Modified-board mapping: ITANK_MOD -> J26.31 -> ADCC11.
//
#define CLLLC_ITANK_MOD_ADC_MODULE              ADCC_BASE
#define CLLLC_ITANK_MOD_ADC_PIN                 ADC_CH_ADCIN11
#define CLLLC_ITANK_MOD_ADC_ACQPS_SYS_CLKS      CLLLC_ADC_ACQPS_SYS_CLKS
#define CLLLC_ITANK_MOD_ADCRESULTREGBASE        ADCCRESULT_BASE
#define CLLLC_ITANK_MOD_ADC_TRIG_SOURCE         CLLLC_ADC_SOC_TRIG_ISR2
#define CLLLC_ITANK_MOD_ADC_SOC_NO              ADC_SOC_NUMBER2
#define CLLLC_ITANK_MOD_ADCREAD ADC_readResult(                     \
        CLLLC_ITANK_MOD_ADCRESULTREGBASE,                           \
...
#define CLLLC_IPRIM_TANK_CMPSS_ASYSCTRL_CMPHPMUX ASYSCTL_CMPHPMUX_SELECT_2
#define CLLLC_IPRIM_TANK_CMPSS_ASYSCTRL_CMPLPMUX ASYSCTL_CMPLPMUX_SELECT_2
#define CLLLC_IPRIM_TANK_CMPSS_ASYSCTRL_MUX_VALUE 1
