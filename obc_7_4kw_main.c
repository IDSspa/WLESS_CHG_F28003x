...
//    GPIO_setPinConfig(GPIO_13_GPIO13);  // Disable Phase 2
    ...
    for(;;)
    {
        ...
        //
        // The WLESS logical tick is generated by ISR2 and decimated to 1 kHz.
        // Service it, the gated FSM dispatch and the nRF IRQ/TX path directly
        // from the superloop: Task A runs at 100 Hz and would otherwise merge
        // ten operational message requests into its single pending flag.
        //
...
//
//=============================================================================
//  A - TASKS (executed at CLLLC_TASKA_FREQ_HZ, currently 100 Hz)
//=============================================================================
//
