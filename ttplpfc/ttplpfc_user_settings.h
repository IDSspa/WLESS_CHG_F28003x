...
//
#define TTPLPFC_LOW_FREQ_PWM_ENABLED                0
#define TTPLPFC_LOW_FREQ_PWM_BASE                   EPWM5_BASE

#define TTPLPFC_LOW_FREQ_PWM_H_GPIO                 8
#define TTPLPFC_LOW_FREQ_PWM_H_GPIO_PIN_CONFIG      GPIO_8_EPWM5_A
#define TTPLPFC_LOW_FREQ_PWM_H_GPIO_DISABLED_CONFIG GPIO_8_GPIO8


#define TTPLPFC_LOW_FREQ_PWM_L_GPIO                 9
#define TTPLPFC_LOW_FREQ_PWM_L_GPIO_PIN_CONFIG      GPIO_9_EPWM5_B
#define TTPLPFC_LOW_FREQ_PWM_L_GPIO_DISABLED_CONFIG GPIO_9_GPIO9
...
//
// WLESS battery/input voltage measurement.
// Board mapping: VIN_ADC -> J26.39 -> controlCARD ADCA3/ADCB9/ADCC7.
// ADCC7 is selected here.
// SOC13 is unused on ADCC by the current TTPLPFC/CLLLC allocation.
//
#define TTPLPFC_VBAT_ADC_MODULE  ADCC_BASE
#define TTPLPFC_VBAT_ADC_SOC_NO  ADC_SOC_NUMBER13
#define TTPLPFC_VBAT_ADC_PIN     ADC_CH_ADCIN7
#define TTPLPFC_VBAT_ADC_TRIG_SOURCE TTPLPFC_ADC_SOC_TRIG5
#define TTPLPFC_VBAT_ADC_ACQPS_SYS_CLKS TTPLPFC_ADC_ACQPS_SYS_CLOCKS
#define TTPLPFC_VBAT_ADCRESULTREGBASE ADCCRESULT_BASE
...
#define TTPLPFC_VBAT_FB      ADC_readResult(TTPLPFC_VBAT_ADCRESULTREGBASE, TTPLPFC_VBAT_ADC_SOC_NO)
...
#define TTPLPFC_IL1_OFFSET_PU ((float32_t)0.50944)
#define TTPLPFC_IL2_OFFSET_PU ((float32_t)0.49244)
