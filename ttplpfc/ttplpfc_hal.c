...
void TTPLPFC_HAL_setupADC(void)
{
    ...
    // VIN_ADC -> J26.39 -> ADCA3/ADCB9/ADCC7; use ADCC7.
    ADC_setupSOC(TTPLPFC_VBAT_ADC_MODULE, TTPLPFC_VBAT_ADC_SOC_NO,
                TTPLPFC_VBAT_ADC_TRIG_SOURCE,
                TTPLPFC_VBAT_ADC_PIN, TTPLPFC_VBAT_ADC_ACQPS_SYS_CLKS);
